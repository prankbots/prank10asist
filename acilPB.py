# -*- coding: utf-8 -*-
import LINETCR
from LINETCR.libapi.ttypes import *	
...
#----------------------------------------------
		    ...
		    a = msg.text.replace("Xvideos ","")
                ...
                if len(string.decode('utf-8')) <= 500:
                    ...
                    cl.sendText(msg.to,"􀜁􀇔􏿿Update Bio\n👉" + string + "👈")
#------------------------------------------------------------------------------------------#
            elif "Cn " in msg.text:
	...
	if op.type == 11:
        ...
        if op.type == 5:
            if wait["autoAdd"] == True:
                ...
                cl.sendImageWithURL(op.param1,"http://dl.profile.line-cdn.net/0hPV_dx45gD3liHSNSj09wLl5YARQVMwkxGntGT0YUVhsdeh8oXnIUGUMYVUBGfUgvX3JCHUMUVk8Y")
                if (wait["message"] in [""," ","\n",None]):
                    pass
                else:
